...
\begin{frame}{Simulation Results}
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      \begin{block}{Case 2: Optimal $L(z)$}
        \centering
        \begin{figure}
        \includegraphics[scale=0.18]{fig4.jpg}
        \end{figure}
  ...
  \vspace{0.4em}
  \centering
  \small\textit{(Schematic step-response illustrations; solid = achieved, light = reference model $M(z)$)}
\end{frame}
...
\begin{frame}
  \begin{columns}[T]
    \begin{column}{0.45\textwidth}
    \begin{block}{Case 3: Optimal $L(z)$ with noise and without IV}
        \centering
        \begin{figure}
        \includegraphics[scale=0.25]{fig5.jpg}
        \end{figure}
        \highlight{Without IV:} performance degraded
      \end{block}
      \end{column}
      \begin{column}{0.45\textwidth}
      \begin{block}{Case 4: Optimal $L(z)$ with noise + IV}
        \centering
        \begin{figure}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Nonlinear Plant $P$}
        ...
        \begin{align*}
        y(t) =  p(&y(t-1),\ldots,y(t-n_{P_y}),\\ &u(t-1),\ldots,u(t-n_{P_u}))
        \end{align*}
      ...
      \begin{block}{Parameterized Controller $C_\theta$}
        \begin{align*}
          u(t) = c(&u(t-1),\ldots,u(t-n_{C_u}),\\ & e(t),\ldots,e(t-n_{C_e});\;\theta)
        \end{align*}
