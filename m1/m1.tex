...
\item The sparse identification of nonlinear dynamics (SINDy) algorithm uses sparse regression [280] in a nonlinear function space to determine the relevant terms in the dynamics.
